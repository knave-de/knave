...
These documents describe the intended Rust/Cargo-first transition. They do not
claim that the transitional Qt shell or legacy Villain tools have already been
removed.
